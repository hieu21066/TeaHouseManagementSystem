...
public class ReservationService {
    ...
    public String generateNextId() {
        ...
        for (Reservation r : reservationList) {
            try {
                max = Math.max(max, Integer.parseInt(r.getReservationId().substring(3)));
            } catch (Exception e) {
            }
        }
    ...
    public void sortByCustomerName() {
        reservationList.sort(Comparator.comparing(Reservation::getCustomerName));
        updateFile();
    }

    public void sortByTableNumber() {
        reservationList.sort(Comparator.comparingInt(Reservation::getTableNumber));
        updateFile();
    }
